...
const Tabview = ({ tab1, tab2 }) => {
  return (
    <Tabs>
      {/* Tab Buttons */}
      <TabList className="flex flex-wrap justify-end mr-6 md:mr-18 gap-6 my-6 font-quicksand">
        {/* Tab 1 */}
        <Tab
          className="relative px-16 py-3 text-lg font-bold border-2 rounded-lg transition-all duration-300 cursor-pointer
          bg-[#F5E1C6] text-[#D97706] border-[#D97706] font-playfair"
        ...
        {/* Tab 2 (Fixed Hover Issue) */}
        <Tab
          className="relative px-14 py-3 text-lg font-bold border-2 rounded-lg transition-all duration-300 cursor-pointer
      ...
      {/* Content Box */}
      <div className="mx-2 my-1 px-4 py-6 pb-12 rounded-lg font-quicksand">
