    ...
    <div className='px-4 sm:px-0 flex justify-center items-center relative'>
      ...
      >
        <div className='overflow-visible mb-5'>
          ...
          <h2 className='text-green-800 textShadow-md text-4xl sm:text-5xl md:text-6xl overflow-visible font-semibold font-figtree mt-2 spring-title'>
            Rang-E-Chinar
          </h2>
        </div>
        <div>
          <p className='text-base sm:text-base md:text-base text-green-700 leading-relaxed'>
